...
@section('container')
 <div class="shadow ">
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      <p>Memberikan layanan perbankan dengan mengutamakan pelayanan prima, profesionalisme kerja & dedikasi tinggi untuk mencapai hasil yang maksimal.</p>
      <footer class="blockquote-footer">PT BPR CENTRAL INTERNATIONAL </footer>
    </blockquote>
   </div>
</div>
